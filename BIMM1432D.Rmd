...
# For this four lines codes, I added one hidden layers and one outer layers to the original model with the input-shape as 8(8 column in total) For the unit, I choosed a randomized small unit to test on this layers. 
model %>% 
